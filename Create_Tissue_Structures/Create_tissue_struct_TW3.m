...
imname = 'testspruce_TW3'; % image name
...
stats([1,2]) = []; % remove fibers for TW3
stats(133:end) = []; % remove fibers for TW3
...
maskpts = close_spline(scale_spline(maskpts, C, -4*layer_thick(1)));
